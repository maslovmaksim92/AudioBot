...
3. **Настройте обработчик событий**
   ...
   - **Обработчик (URL):** 
     ```
     https://finance-forecast-14.preview.emergentagent.com/api/bitrix-webhook/call-finished
     ```
...
```bash
curl https://finance-forecast-14.preview.emergentagent.com/api/bitrix-webhook/test
```
