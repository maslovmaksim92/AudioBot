...
3. **Настройте обработчик событий**
   ...
   - **Обработчик (URL):** 
     ```
     https://bitrix-audio-1.preview.emergentagent.com/api/bitrix-webhook/call-finished
     ```
...
```bash
curl https://bitrix-audio-1.preview.emergentagent.com/api/bitrix-webhook/test
```
