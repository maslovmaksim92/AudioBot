...
### 3. AI Чат
- **Единый мозг (Brain)**: быстрые ответы без LLM с продвинутым NER
  - ✅ Контакты старшего по адресу
  - ✅ График уборок по адресу и месяцу (октябрь/ноябрь/декабрь)
  - ✅ Информация о бригаде по адресу
  - ✅ Контакты подрядчиков/УК по адресу
  - ✅ Задачи и жалобы по адресу
  - ✅ Задачи по бригаде
  - ✅ Финансовая статистика (доходы/расходы/прибыль)
  - ✅ Разбивка по категориям
  - ✅ Динамика М/М и Г/Г
  - ✅ Структурные суммы (дома/квартиры/этажи/подъезды)
- **Продвинутый NER (Named Entity Recognition)**:
  - Адреса: "Кибальчича 3 стр 2", "Билибина 6 к1 лит А", "объект на Ленина 5"
  - Месяцы: "октябрь", "в октябре", "10 месяц", "окт", "11.2025"
  - Даты: "15 октября", "2025-10-15", "сегодня", "завтра"
  - Диапазоны: "с 1 по 15 октября", "01.10-15.10", "за месяц", "за квартал"
  - Приоритизация интентов с confidence scores
- Debug-режим для админов (правило/время/источник), мини-хинт в ответе
- Fallback к LLM при отсутствии совпадений правил
- База знаний (RAG с pgvector)
- Кэширование и circuit breaker для надёжности
