...
async def ai_chat_endpoint(request: ChatRequest):
    ...
    try:
        ...
        if "дом" in user_msg or "квартир" in user_msg:
            ...
            ai_response = f"Спасибо за вопрос! Я VasDom AI и помогаю с управлением клининговой компанией. У нас 490 домов в управлении, 82 сотрудника в 6 бригадах. Что вас интересует? 🏢"
