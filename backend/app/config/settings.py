...
CORS_ORIGINS_RAW = os.environ.get('CORS_ORIGINS', 'https://crm-connector-2.preview.emergentagent.com,https://audiobot-qci2.onrender.com')
CORS_ORIGINS = [origin.strip() for origin in CORS_ORIGINS_RAW.split(',') if origin.strip()]

# Безопасные дефолтные origins если переменная пустая
if not CORS_ORIGINS:
    CORS_ORIGINS = [
        "https://crm-connector-2.preview.emergentagent.com",
