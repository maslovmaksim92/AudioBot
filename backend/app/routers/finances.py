                ...
                ufic_excel_data = {
                    "pessimistic": {
                        ...
                        "detailed_description": {
                            ...
                            "advantages": [
                                "Максимальная загрузка уборщицами (45 чел) обеспечивает высокую выручку",
                                "Стабильные долгосрочные контракты с управляющими компаниями",
                                "Минимальные риски за счет небольшого штата швей и аутсорсинга",
                                "Предсказуемая структура расходов (ФОТ 39,200₽/чел)",
                                "Низкие требования к управлению малым коллективом"
                            ],
                            "disadvantages": [
                                "Ограниченная диверсификация услуг (преобладание уборки)",
                                "Зависимость от рынка услуг уборки",
                                "Малый штат швей (10 чел) ограничивает потенциал роста",
                                "Слабое развитие аутсорсинга (5 чел)",
                                "Уязвимость к потере ключевых клиентов-УК"
                            ]
                        },
                    ...
                    "realistic": {
                        ...
                        "detailed_description": {
                            "summary": "Реалистичный сценарий на основе текущих показателей",
                            "revenue_factors": [
                                "Оптимальная загрузка рабочих мест по всем направлениям",
                                "Расширение предоставляемых услуг (швеи, уборка, аутсорсинг)",
                            ...
                            "expense_factors": [
                                ...
                                "Текущий ремонт: 3,429 ₽/сотрудник"
                            ],
                            "unit_economics": {
                            ...
                            "advantages": [
                                ...
                                "Развитое направление аутсорсинга (20 чел) открывает новые возможности",
                                "Умеренные расходы на управление (4,800₽/чел)",
                            ...
                            "disadvantages": [
                                ...
                                "Риск распыления ресурсов между разными услугами",
                                "Требуется эффективное управление увеличенным штатом (65 чел)",
                    ...
                    "optimistic": {
                        ...
                        "detailed_description": {
                            "summary": "Оптимистичный прогноз с расширением производства",
                            "revenue_factors": [
                                "Активное расширение клиентской базы управляющих компаний",
                                "Профессиональное обучение персонала для повышения качества",
                            ...
                            "expense_factors": [
                                ...
                                "Текущий ремонт: 3,769 ₽/сотрудник"
                            ],
                            "unit_economics": {
                            ...
                            "advantages": [
                                ...
                                "Крупнейший штат (80 чел) позволяет обслуживать больше клиентов",
                                "Максимальное количество швей (20 чел) расширяет производственные возможности",
                                "Самая низкая стоимость управления (4,460₽/чел)",
                                "Наивысшая прибыль на сотрудника (23,829₽)"
                            ],
                            "disadvantages": [
                                "Минимальная загрузка уборщицами (30 чел) среди всех сценариев",
                                "Высокие риски при управлении крупным штатом (80 чел)",
                                "Сильная зависимость от успеха аутсорсингового направления",
                                "Необходимость значительных инвестиций в обучение и развитие",
                                "Сложность поддержания качества при быстром масштабировании"
                            ]
                        },
                        "revenue_breakdown_2026": {
                            "sewing": 16044750.00,
                ...
                "pessimistic": {
                    ...
                    "detailed_description": {
                        ...
                        "revenue_factors": [
                            ...
                            "Сохранение текущих цен на услуги с минимальной индексацией",
                            "Медленное расширение персонала",
                            "Улучшение качества сервиса для удержания клиентов",
                            "Рост выручки 2026: +10% ежегодно"
                        ],
                        "expense_factors": [
                            "Зарплата: основная статья расходов (60-65% от общих расходов)",
                            "Индексация ФОТ на уровне инфляции 7-9%",
                            "Операционные расходы: аренда, коммунальные услуги",
                        ...
                        "advantages": [
                            ...
                            "Низкие инвестиционные требования на старте",
                        ...
                        "disadvantages": [
                            ...
                            "Риск отставания от конкурентов при изменении рынка",
                            "Низкая гибкость при необходимости быстрого расширения"
                        ]
                    }
                },
                "realistic": {
                    ...
                    "description": "Реалистичный прогноз: стабильный уверенный рост, маржа растет с 22% до 37%",
                    "detailed_description": {
                        ...
                        "revenue_factors": [
                            ...
                            "Умеренное повышение цен на 5-7% ежегодно",
                            "Оптимизация бизнес-процессов и повышение производительности",
                            "Рост выручки 2026: +13% ежегодно с 2027 года"
                        ],
                        "expense_factors": [
                            ...
                            "Маркетинг и продвижение: 3-5% от выручки",
                            "Оптимизация расходов для роста маржи с 22% до 37%"
                        ],
                        "advantages": [
                            "Сбалансированный подход между ростом и стабильностью",
                            "Постепенное улучшение рентабельности (маржа растет с 22% до 37%)",
                            "Диверсификация клиентской базы за счет B2B контрактов",
                            "Умеренные инвестиционные требования",
                            "Реалистичные темпы роста, достижимые при текущем рынке"
                        ],
                        "disadvantages": [
                            ...
                            "Конкуренция за корпоративных клиентов может быть высокой",
                            "Риск перегрузки команды при быстром росте"
                        ]
                    }
                },
                "optimistic": {
                    "years_data": [
                        {"year": 2026, "revenue": 75393318.00, "expenses": 58806788.04},
                        {"year": 2027, "revenue": 86702315.70, "expenses": 65026736.78},
                        {"year": 2028, "revenue": 99707663.06, "expenses": 71789517.40},
                        {"year": 2029, "revenue": 114663812.50, "expenses": 77971392.50},
                        {"year": 2030, "revenue": 131863384.40, "expenses": 83073932.17},
                    ],
                    "description": "Оптимистичный прогноз: активный рост, маржа растет с 22% до 37%",
                    "detailed_description": {
                        ...
                        "revenue_factors": [
                            ...
                            "Агрессивное повышение цен на 10-15% на фоне роста качества",
                            "Рост выручки 2026: +15% ежегодно с 2027 года"
                        ],
                        "expense_factors": [
                            ...
                            "Инвестиции в IT-системы, CRM, автоматизацию: 8-10% от расходов",
                            "Развитие партнерской сети",
                            "Активная оптимизация процессов для роста маржи с 22% до 37%"
                        ],
                        "advantages": [
                            ...
                            "Автоматизация процессов повышает эффективность",
                            "Географическая диверсификация снижает региональные риски"
                        ],
                        "disadvantages": [
                            ...
                            "Зависимость от успешного запуска premium-услуг",
                            "Необходимость постоянного поддержания высокого качества при масштабировании"
                        ]
                    }
                }
            }
