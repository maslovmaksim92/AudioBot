...
async def get_forecast(
    ...
    try:
        ...
        try:
                ...
                ufic_excel_data = {
                    "pessimistic": {
                        ...
                        "detailed_description": {
                            ...
                            "revenue_factors": [
                                "Стабильная работа с текущими клиентами",
                                "Швеи: 60 мест, Уборщицы: 60 мест, Аутсорсинг: 14 мест",
                                "Минимальная индексация цен 6% ежегодно"
                            ],
                            "expense_factors": [
                                "Фонд оплаты труда с учетом индексации",
                    ...
                    "realistic": {
                        ...
                        "detailed_description": {
                            ...
                            "revenue_factors": [
                                ...
                                "Швеи: 41 место, Уборщицы: 40 мест, Аутсорсинг: 5 мест",
                                "Привлечение новых заказов",
                                "Индексация 6% ежегодно"
                            ],
                            "expense_factors": [
                                "ФОТ с учетом роста производительности",
                                "Операционные расходы в рамках текущих показателей"
                            ]
                        },
                        "revenue_breakdown_2026": {
                            "sewing": 15739135.71,
                            "cleaning": 24615780.00,
                            "outsourcing": 14332500.00
                        },
                        "expense_breakdown_2026": {
                            "labor": 36947205.43
                        },
                    ...
                    "optimistic": {
                        ...
                        "detailed_description": {
                            ...
                            "revenue_factors": [
                                "Активное расширение производства",
                                "Швеи: 65 мест, Уборщицы: 70 мест, Аутсорсинг: 20 мест",
                                "Привлечение крупных корпоративных контрактов",
                                "Повышенная индексация 10% ежегодно",
                                "Выход на новые рынки"
                            ],
                            "expense_factors": [
                                "Увеличенный фонд оплаты труда",
                                "Инвестиции в развитие и масштабирование",
            ...
            vasdom_scenarios = {
                "pessimistic": {
                    "revenue_2026": 56539380,  # Фиксированная выручка 2026
                    "revenue_growth": 1.10,     # +10% ежегодно
                    "expense_growth": 1.097,    # +9.7% ежегодно
                    "description": "Пессимистичный прогноз: рост выручки +10%, расходов +9.7%",
                    "detailed_description": {
                        "summary": "Консервативный сценарий с минимальным ростом",
                        "revenue_factors": [
                            "Медленное расширение клиентской базы",
                            "Сохранение текущих цен на услуги",
                            "Минимальная маркетинговая активность"
                        ],
                        "expense_factors": [
                            "Индексация зарплат на уровне инфляции",
                            "Минимальные затраты на развитие"
                        ]
                    }
                },
                "realistic": {
                    "revenue_growth": 1.20,     # +20% ежегодно
                    "expense_growth": 1.162,    # +16.2% ежегодно
                    "description": "Реалистичный прогноз: рост выручки +20%, расходов +16.2%",
                    "detailed_description": {
                        "summary": "Базовый прогноз на основе текущих трендов 2025 года",
                        "revenue_factors": [
                            "Расширение портфеля услуг по клининг",
                            "Привлечение новых корпоративных клиентов",
                            "Умеренное повышение цен (5-7%)",
                            "Оптимизация бизнес-процессов"
                        ],
                        "expense_factors": [
                            "Увеличение штата сотрудников",
                            "Инвестиции в оборудование и технологии",
                            "Маркетинговые расходы для привлечения клиентов"
                        ]
                    }
                },
                "optimistic": {
                    "revenue_growth": 1.30,     # +30% ежегодно
                    "expense_growth": 1.225,    # +22.5% ежегодно (скорректировано для маржи 27.58%-36.42%)
                    "description": "Оптимистичный прогноз: рост выручки +30%, расходов +22.5%",
                    "detailed_description": {
                        "summary": "Оптимистичный прогноз: ускоренный рост выручки, оптимизация расходов",
                        "revenue_factors": [
                            "Активное расширение в новые регионы",
                            "Запуск дополнительных сервисов (генеральная уборка, химчистка)",
                            "Привлечение крупных контрактов B2B",
                            "Повышение цен на 10-15%",
                            "Масштабирование франшизной модели"
                        ],
                        "expense_factors": [
                            "Масштабирование операций",
                            "Интенсивный маркетинг и реклама",
                            "Инвестиции в IT-системы и автоматизацию",
