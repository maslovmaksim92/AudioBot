...
class BitrixService:
    ...
    async def _get_demo_houses(self) -> List[Dict[str, Any]]:
        """Демо данные домов для тестирования с правильными графиками из CRM"""
        return [
            {
                'ID': '1001',
                'TITLE': 'ул. Аллейная, д. 10',
                'UF_CRM_1669704529022': '48',
                'UF_CRM_1669705507390': '3', 
                'UF_CRM_1669704631166': '9',
            ...
            {
                'ID': '1002', 
                'TITLE': 'ул. Аллейная, д. 6, п. 1',
                'UF_CRM_1669704529022': '32',
                'UF_CRM_1669705507390': '2',
                'UF_CRM_1669704631166': '9', 
                'UF_CRM_1669708345534': 'ООО "УПРАВЛЯЮЩАЯ КОМПАНИЯ АЛЬФА"',
                'UF_CRM_1693297230181': '05.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;|12.09.2025|Подметание лестничных площадок и маршей всех этажей, влажная уборка 1 этажа и лифта (при наличии); Профилактическая дезинфекция МОП;|19.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;|26.09.2025|Подметание лестничных площадок и маршей всех этажей, влажная уборка 1 этажа и лифта (при наличии); Профилактическая дезинфекция МОП;'
            },
            {
                'ID': '1003',
                'TITLE': 'ул. Аэропортовская, д. 14',
                'UF_CRM_1669704529022': '120',
                'UF_CRM_1669705507390': '6',
                'UF_CRM_1669704631166': '10',
                'UF_CRM_1669708345534': 'ООО "БЕТА СЕРВИС"', 
                'UF_CRM_1693297230181': '10.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;|24.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;'
            },
            {
                'ID': '1004',
                'TITLE': 'пр. Ленина, д. 25',
                'UF_CRM_1669704529022': '75',
                'UF_CRM_1669705507390': '4',
                'UF_CRM_1669704631166': '12', 
                'UF_CRM_1669708345534': 'ТСЖ "ЦЕНТРАЛЬНОЕ"',
                'UF_CRM_1693297230181': '03.09.2025|Подметание лестничных площадок и маршей всех этажей, влажная уборка 1 этажа и лифта (при наличии); Профилактическая дезинфекция МОП;|10.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;|17.09.2025|Подметание лестничных площадок и маршей всех этажей, влажная уборка 1 этажа и лифта (при наличии); Профилактическая дезинфекция МОП;|24.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;'
            },
            {
                'ID': '1005',
                'TITLE': 'ул. Советская, д. 8А',
                'UF_CRM_1669704529022': '56',
                'UF_CRM_1669705507390': '3',
                'UF_CRM_1669704631166': '9',
                'UF_CRM_1669708345534': 'ТСЖ "СОВЕТСКОЕ"',
                'UF_CRM_1693297230181': '12.09.2025|Влажная уборка лестничных площадок всех этажей и лифта (при наличии); Профилактическая дезинфекция МОП;|26.09.2025|Подметание лестничных площадок и маршей всех этажей, влажная уборка 1 этажа и лифта (при наличии); Профилактическая дезинфекция МОП;'
            }
        ]
