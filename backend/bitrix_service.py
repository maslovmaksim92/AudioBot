...
class BitrixService:
    ...
    async def _get_demo_houses(self) -> List[Dict[str, Any]]:
        """Демо данные домов для тестирования"""
        return [
            {
                'ID': '1001',
                ...
                'UF_CRM_1693297230181': '15.09-понедельник, 17.09-среда'
            },
            {
                'ID': '1002', 
                ...
                'UF_CRM_1669704631166': '9', 
                'UF_CRM_1669708345534': 'ТСЖ "Аллейная"',
                'UF_CRM_1693297230181': '16.09-вторник, 18.09-четверг'
            },
            {
                'ID': '1003',
                ...
                'UF_CRM_1693297230181': '14.09-воскресенье, 21.09-воскресенье'
            },
            {
                'ID': '1004',
                ...
                'UF_CRM_1693297230181': '13.09-суббота, 19.09-пятница'
            },
            {
                'ID': '1005',
                ...
                'UF_CRM_1693297230181': '12.09-пятница, 20.09-суббота'
            }
        ]
