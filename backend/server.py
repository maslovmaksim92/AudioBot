...
class BitrixService:
    ...
    async def get_deals_optimized(self,
...
async def get_houses(
    ...
    try:
                ...
                for m in cd.values():
                    ...
                    for dt in dates:
                        ...
                        if date_from and date_to and (date_from <= dt <= date_to):
                            return True
                return False
            filtered = [deal for deal in deals if matches_date(deal)]
        ...
        for deal in deals:
            ...
            # periodicity based on September rules
...
async def get_filters():
    try:
        response = await bitrix_service._make_request("crm.deal.list", {
