...
class AdvancedAI:
    ...
    async def _emergent_ai_response(self, text: str, context: str) -> str:
        ...
        system_message = """Ты VasDom AI - помощник клининговой компании в Калуге.

ДАННЫЕ КОМПАНИИ:
🏠 Домов в управлении: 491 (из CRM Bitrix24)
...
Отвечай как эксперт, используй эмодзи, давай конкретные цифры."""
    ...
    async def _advanced_fallback_response(self, text: str, context: str) -> str:
        ...
        if any(word in text_lower for word in ['привет', 'hello', 'здравств']):
            response = """Привет! 👋 Я VasDom AI - помощник клининговой компании в Калуге! 

📊 **Данные:**
🏠 **491 дом** из CRM Bitrix24
...
🤖 **VasDom AI:** У нас 491 дом, 6 бригад, 82 сотрудника в Калуге.
...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <h3>🚀 VasDom AudioBot готов к работе!</h3>
            <p>Система управления 491 домом в Калуге через AI</p>
            
            <div style="margin-top: 30px;">
                <a href="/api/" class="btn">🔗 API Документация</a>
                <a href="/api/health" class="btn">🏥 Статус системы</a>
                <a href="/api/telegram/status" class="btn">📱 Telegram бот</a>
            </div>
        </div>
    </div>
</body>
