                ...
                <Card key={item.id}>
                  <CardContent className="pt-6 flex justify-between">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <Button variant="outline" size="sm" onClick={() => { setEditingItem(item); setFormData({ name: item.name, category: item.category, quantity: item.quantity, unit: item.unit, cost: item.cost, location: item.location || '' }); setShowDialog(true); }}>
