    ...
    <div className="p-6">
      ...
      <Card title="💡 Информация" className="mt-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
          <div>
            <h4 className="font-medium text-gray-900 mb-2">🎯 Как начать запись:</h4>
            <ol className="space-y-1 list-decimal list-inside">
              <li>Введите название планерки</li>
              <li>Нажмите "🎤 Начать запись"</li>
              <li>Разрешите доступ к микрофону</li>
              <li>Говорите четко и громко</li>
              <li>Нажмите "⏹️ Остановить запись"</li>
            </ol>
          </div>
          <div>
            <h4 className="font-medium text-gray-900 mb-2">⚙️ Возможности:</h4>
            <ul className="space-y-1">
              <li>• Автоматическая транскрипция речи</li>
              <li>• Сохранение записей</li>
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>💡 Подсказка:</strong> Если кнопка "Начать запись" неактивна, убедитесь что:
            ✓ Введено название планерки ✓ Разрешен доступ к микрофону ✓ Используется Chrome браузер
          </p>
        </div>
      </Card>
    </div>
