...
**🔴 ФАЗА 2A: Критические баги (1-2 дня)**
1. Исправить баг с определением месяца (November вместо October)
2. Исправить логику периодичности в карточке дома (3 типа уборок)
3. Исправить баг пересчёта КПИ бригад при выборе даты
